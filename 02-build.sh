...
microk8s.kubectl apply  -f /opt/k8s-spring-cloud-parent-V1/app01/docker-k8s/k8s-app01.yaml
microk8s.kubectl apply  -f /opt/k8s-spring-cloud-parent-V1/app02/docker-k8s/k8s-app02.yaml
microk8s.kubectl apply  -f /opt/k8s-spring-cloud-parent-V1/demo-springcloud-zuul/docker-k8s/k8s-api-gateway.yaml
